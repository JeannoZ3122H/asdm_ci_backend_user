...
@Component({
  selector: 'app-views-projet-repport-base-admin',
  templateUrl: './views-projet-repport-base-admin.component.html',
  styleUrls: ['./views-projet-repport-base-admin.component.css']
})
export class ViewsProjetRepportBaseAdminComponent implements OnInit{
