...
@Component({
  selector: 'app-project-completed-commercials',
  templateUrl: './project-completed-commercials.component.html',
  styleUrls: ['./project-completed-commercials.component.css']
})
export class ProjectCompletedCommercialsComponent {
    ...
    getListeProjetCommercialResolved() {
        this._request.getAllProjectsCompletedCommercial().subscribe(
            {
                next: (response: any) => {
