...
@Component({
  selector: 'app-assigned-projets',
  templateUrl: './assigned-projets.component.html',
  styleUrls: ['./assigned-projets.component.css']
})
export class AssignedProjetsComponent implements OnInit{
    ...
    reasignedAsEvaluator(data: any) {
        localStorage.setItem('niveau_code_help', data.niveau_code);
