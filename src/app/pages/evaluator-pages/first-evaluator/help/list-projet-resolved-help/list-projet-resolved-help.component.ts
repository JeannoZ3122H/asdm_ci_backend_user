...
@Component({
  selector: 'app-list-projet-resolved-help',
  templateUrl: './list-projet-resolved-help.component.html',
  styleUrls: ['./list-projet-resolved-help.component.css']
})
export class ListProjetResolvedHelpComponent implements OnInit{
