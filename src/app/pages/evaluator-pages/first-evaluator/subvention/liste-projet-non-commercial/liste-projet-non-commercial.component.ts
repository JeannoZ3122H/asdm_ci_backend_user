...
@Component({
    selector: 'app-liste-projet-non-commercial',
    templateUrl: './liste-projet-non-commercial.component.html',
    styleUrls: ['./liste-projet-non-commercial.component.css']
})
export class ListeProjetNonCommercialComponent implements OnInit {
