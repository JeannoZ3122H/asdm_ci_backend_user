...
@Component({
  selector: 'app-list-projet-resolved-commercial',
  templateUrl: './list-projet-resolved-commercial.component.html',
  styleUrls: ['./list-projet-resolved-commercial.component.css']
})
export class ListProjetResolvedCommercialComponent implements OnInit{
