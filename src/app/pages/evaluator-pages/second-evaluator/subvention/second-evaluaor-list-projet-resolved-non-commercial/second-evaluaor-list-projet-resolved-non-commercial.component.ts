...
@Component({
  selector: 'app-second-evaluaor-list-projet-resolved-non-commercial',
  templateUrl: './second-evaluaor-list-projet-resolved-non-commercial.component.html',
  styleUrls: ['./second-evaluaor-list-projet-resolved-non-commercial.component.css']
})
export class SecondEvaluaorListProjetResolvedNonCommercialComponent implements OnInit{
