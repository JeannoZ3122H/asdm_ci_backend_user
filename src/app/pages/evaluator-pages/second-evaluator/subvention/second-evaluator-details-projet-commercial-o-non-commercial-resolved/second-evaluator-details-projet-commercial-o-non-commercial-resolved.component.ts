...
@Component({
  selector: 'app-second-evaluator-details-projet-commercial-o-non-commercial-resolved',
  templateUrl: './second-evaluator-details-projet-commercial-o-non-commercial-resolved.component.html',
  styleUrls: ['./second-evaluator-details-projet-commercial-o-non-commercial-resolved.component.css']
})
export class SecondEvaluatorDetailsProjetCommercialONonCommercialResolvedComponent {
