...
@Component({
  selector: 'app-second-evaluator-details-projet-help-resolved',
  templateUrl: './second-evaluator-details-projet-help-resolved.component.html',
  styleUrls: ['./second-evaluator-details-projet-help-resolved.component.css']
})
export class SecondEvaluatorDetailsProjetHelpResolvedComponent {
