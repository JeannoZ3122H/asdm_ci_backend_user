...
@Component({
    selector: 'app-second-evaluator-home',
    templateUrl: './second-evaluator-home.component.html',
    styleUrls: ['./second-evaluator-home.component.css']
})
export class SecondEvaluatorHomeComponent implements OnInit {
    public pE: number = 1;
    public pO: number = 1;
    public pF: number = 1;
