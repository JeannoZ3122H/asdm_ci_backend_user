...
export class DocsFournirService {
...
// 😇😇 **** REQUEST
    // get
    get = () =>{
        const url = this._api_url.apiUrl+'get_document_fournir';
        return this._http.get(url);
    }
    // store
    store = (data: any) =>{
        const url = this._api_url.apiUrl+'store_document_fournir';
        return this._http.post(url, data);
    }
    // update
    update = (slug:any ,data: any) =>{
        const url = this._api_url.apiUrl+'update_document_fournir/'+slug;
        return this._http.post(url, data);
    }
    // delete
    delete = (slug: any) =>{
        const url = this._api_url.apiUrl+'destroy_document_fournir/'+slug;
        return this._http.get(url);
    }
