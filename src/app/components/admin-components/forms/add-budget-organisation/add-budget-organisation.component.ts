...
import { BudgetAnnuelService } from 'src/app/services/request/budget-annuel/budget-annuel.service';
import { AddTypeMediaComponent } from '../add-type-media/add-type-media.component';

@Component({
  selector: 'app-add-budget-organisation',
  templateUrl: './add-budget-organisation.component.html',
  styleUrls: ['./add-budget-organisation.component.css']
})
export class AddBudgetOrganisationComponent implements OnInit {
