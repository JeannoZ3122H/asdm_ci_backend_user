...
@Component({
  selector: 'app-previews-first-projet-repport-admin',
  templateUrl: './previews-first-projet-repport-admin.component.html',
  styleUrls: ['./previews-first-projet-repport-admin.component.css']
})
export class PreviewsFirstProjetRepportAdminComponent implements OnInit{
