...
@Component({
  selector: 'app-previews-first-projet-repport',
  templateUrl: './previews-first-projet-repport.component.html',
  styleUrls: ['./previews-first-projet-repport.component.css']
})
export class PreviewsFirstProjetRepportComponent implements OnInit{
