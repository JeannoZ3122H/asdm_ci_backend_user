...
@Component({
  selector: 'app-previews-final-projet-repport',
  templateUrl: './previews-final-projet-repport.component.html',
  styleUrls: ['./previews-final-projet-repport.component.css']
})
export class PreviewsFinalProjetRepportComponent implements OnInit{
