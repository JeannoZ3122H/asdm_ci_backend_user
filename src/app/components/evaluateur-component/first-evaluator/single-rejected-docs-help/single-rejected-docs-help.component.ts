...
@Component({
  selector: 'app-single-rejected-docs-help',
  templateUrl: './single-rejected-docs-help.component.html',
  styleUrls: ['./single-rejected-docs-help.component.css']
})
export class SingleRejectedDocsHelpComponent implements OnInit{
    ...
    constructor(
        ...
        public data: any, private _dialogRef: MatDialogRef<SingleRejectedDocsHelpComponent>,
    ) { }
