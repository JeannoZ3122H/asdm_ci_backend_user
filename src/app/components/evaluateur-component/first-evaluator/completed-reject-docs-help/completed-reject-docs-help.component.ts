...
@Component({
  selector: 'app-completed-reject-docs-help',
  templateUrl: './completed-reject-docs-help.component.html',
  styleUrls: ['./completed-reject-docs-help.component.css']
})
export class CompletedRejectDocsHelpComponent implements OnInit{
    ...
    sendMessage(){
        ...
        if(this.data.type == "rejected"){
            ...
            this._request.setProjetHelpCompletedDocsStatus(data).subscribe(
                {
                    next: (response: any) => {
