...
@Component({
  selector: 'app-set-o-update-variation-performance-project',
  templateUrl: './set-o-update-variation-performance-project.component.html',
  styleUrls: ['./set-o-update-variation-performance-project.component.css']
})
export class SetOUpdateVariationPerformanceProjectComponent implements OnInit{
    ...
    constructor(
        ...
        private _dialogRef: MatDialogRef<SetOUpdateVariationPerformanceProjectComponent>,
    ) { }
    ...
    ngOnInit() {
        if(this.data != null ){
            ...
            this._list_year = this.data.detail_performance_projet;
        }
    }
...
// ****************** START FUNCTION REQUEST TO API ****************** //
    ...
    updateDataToDB(){
        ...
        this._loading.start();
        this._request_ev.updatePerformanceProjectVariationData(data).subscribe(
            {
                next: (response: any)=>{
