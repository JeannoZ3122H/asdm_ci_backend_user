...
@Component({
  selector: 'app-validated-docs-comercial-o-non-commercial',
  templateUrl: './validated-docs-comercial-o-non-commercial.component.html',
  styleUrls: ['./validated-docs-comercial-o-non-commercial.component.css']
})
export class ValidatedDocsComercialONonCommercialComponent implements OnInit{
    ...
    constructor(
        ...
        public data: any, private _dialogRef: MatDialogRef<ValidatedDocsComercialONonCommercialComponent>,
    ) { }
